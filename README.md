# react-navigation-demo-expo

This project was bootstrapped with [Create React Native App](https://github.com/react-community/create-react-native-app).

Below you'll find information about performing common tasks. The most recent version of this guide is available [here](https://github.com/react-community/create-react-native-app/blob/master/react-native-scripts/template/README.md).

[Table of Contents of this readme](#table-of-contents)

## Pre-requisites
react-native-scripts binary must be available

Check if binary is available globally on your system
`which react-native-scripts`

If not then install it with
`npm install -g react-native-scripts`

Note: create-react-native-app binary was used to create this demo . Here's how to install it
`npm install -g create-react-native-app`

This demo was tested successfully with:
```
$ yarn --version
0.24.5
$ npm --version
...
```
git clone https://github.com/oguennec/react-navigation-demo-expo.git
cd react-navigation-demo-expo
yarn
```
...
### `yarn run ios`
    ...
    You might have to run the command twice as you could get `Failed to start simulator` although the simulator has started.
...
### `yarn run eject`
    ...
    This will start the process of "ejecting" from Create React Native App's build scripts. It removes this tool and copies build dependencies, configuration files and scripts into the app directory.
...
### adb options when running `yarn run android`
...
## Table of Contents
* [About this demo](#react-navigation-demo-expo)
